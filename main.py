...
def attack(char_name: str, char_class: str) -> str:
    """Describe attack points of a character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Describe defence points of a character."""
    char_defence = 0
    if char_class == 'warrior':
        char_defence = 10 + randint(5, 10)
        return (f'{char_name} блокировал {char_defence} урона')
    if char_class == 'mage':
        char_defence = 10 + randint(-2, 2)
        return (f'{char_name} блокировал {char_defence} урона')
    if char_class == 'healer':
        char_defence = 10 + randint(2, 5)
        return (f'{char_name} блокировал {char_defence} урона')
    return (f'{char_name} не блокировал атаку')


def special(char_name: str, char_class: str) -> str:
    """Describe special perks of a character."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Describe the logic of choosing a character."""
    approve_choice: str = ''
    char_class: str = ''
